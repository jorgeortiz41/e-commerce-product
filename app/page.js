...
export default function Home() {
  ...
  return (
    <div className="flex flex-col mx-24 h-dvh">
      ...
      <main
        id="content"
        className="flex md:flex-row flex-col p-12 gap-16 h-dvh"
      >
        <div id="images" className="flex flex-col gap-8 w-2/4">
          ...
          <div
            id="thumbnails"
            className="flex flex-row gap-4 justify-between h-1/4"
          >
            <button
              id="thumb-1"
              className="rounded-lg relative w-1/4 h-2/3 focus:ring-2 ring-orange-400 outline-none"
              onClick={() => changeImage("/image-product-1.jpg")}
              autoFocus
            >
              <Image
                className={`rounded-lg ${
                  image === "/image-product-1.jpg" ? "opacity-25" : ""
                } hover:opacity-25`}
            ...
            <button
              id="thumb-2"
              className="rounded-lg relative w-1/4 h-2/3 focus:ring-2 ring-orange-400"
              onClick={() => changeImage("/image-product-2.jpg")}
            >
              <Image
                className={`rounded-lg ${
                  image === "/image-product-2.jpg" ? "opacity-25" : ""
                } hover:opacity-25`}
            ...
            >
              <Image
                className={`rounded-lg ${
                  image === "/image-product-3.jpg" ? "opacity-25" : ""
                } hover:opacity-25`}
            ...
            >
              <Image
                className={`rounded-lg ${
                  image === "/image-product-4.jpg" ? "opacity-25" : ""
                } hover:opacity-25`}
        ...
        <div id="details" className="flex flex-col gap-4 justify-center w-2/4 ">
          ...
          <h3 id="product-name" className="text-4xl font-bold">
          ...
          <div
            id="price"
            className="flex flex-row gap-4 text-2xl font-bold items-center mt-8"
          >
            $125.00
